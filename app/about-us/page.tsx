...
function Page() {
  ...
  return (
    <main className='w-full h-full flex justify-start mt-[13rem] flex-col'>
      ...
      <div className="w-full mt-5 h-[30%] flex items-center justify-center ">
        <BlurFade delay={0.25} inView>
          <h1 className='flex flex-col items-center justify-center font-[Poppins] text-[8em] font-medium leading-[1em]'>
            <div><span><span>✳︎</span> CUSTOM SOLUTIONS </span></div>
            <div className='pl-52'><span>FOR YOUR </span></div>
            <div><span>ANSWERS. </span></div>
          </h1>
        </BlurFade>
        <div className="right-[65%] absolute overflow-hidden">
          <BlurFade delay={0.25} inView>
            <h2 className='flex items-center justify-center indent-[3em] w-[22em]'>
              <span>Tailored strategies to meet your unique </span>
            </h2>
            <h2>
              <span>guiding you toward success with needs</span>
            </h2>
            <h2>
              <span>expert insights and dedicated support.</span>
            </h2>
          </BlurFade>
        </div>
      </div>

      <div className='flex items-center justify-start gap-[10rem] pt-[8em] px-[8em]'>
        <div>
          <p className='text-[1.6em] pb-[0.2rem]'>Here’s how we can help</p>
          <div className='w-full bg-white h-[0.1rem]'></div>
        </div>
      </div>

      <div className='h-screen flex items-center justify-center w-full relative pt-[5em]'>
        <video
      ...
      <div className='h-fit w-full pt-[5rem] p-[4em]'>
        <h1 className='font-[Poppins] text-[8em] font-medium leading-[1em] whitespace-nowrap mb-[12rem]'>ABOUT <br /> NITYASHA</h1>
        <div className='content flex'>
          <div className='left w-[35%]'><p className='capitalize text-[1.6em] mt-[1em]'>Think big with us.</p></div>
          <div className='right w-[65%] '>
            <div className='vision  w-fit'>
              <h1 className='capitalize font-medium text-[4em]'>vision of the brand</h1>
              <div className='w-full bg-white h-[0.1rem]'></div>
            </div>
            <p className='text-[1.6em] capitalize mt-20'>We are a forward-thinking consulting firm specializing in advertising, dedicated to enhancing brand visibility in a competitive market. Our mission is to empower businesses to connect authentically with their target audience. Whether developing new strategies or optimizing existing ones, our expert team is here to guide you. We value long-term relationships based on trust and measurable results. Your success is our priority as we shape the future of advertising, one strategy at a time.</p>
          </div>
        </div>
        <div className='w-full flex items-center justify-center mt-20'>
          <img className='w-[90%] h-full' src="https://ik.imagekit.io/sheryians/About%20Us/image%2031_6PfpqHFrv.png?updatedAt=1710496331726" alt="" />
        </div>
      </div>
      <div className="py-14">
      ...
      <div className='w-full h-fit flex items-start justify-start p-[4em] flex-col'>
        ...
        <div className='flex items-center justify-between w-full flex-col mt-20'>
          <div className='flex items-center justify-center h-fit w-full gap-[40em]'>
            <div className='mb-[10em] w-[33%] hoveranime'>
              ...
              <div className='leaderDetails flex justify-between items-center py-[1.5em] border-b-[0.01rem] border-b-white'>
                <h3 className='text-[1.5em] '>Amber Sharma</h3>
      ...
      <div className='flex items-start justify-start flex-col p-[8em] pb-0 socialMedia'>
        <div className="heading mb-[12em] w-full">
          <h1 className='flex flex-col font-[Poppins] text-[8em] font-medium leading-[1em]'>OUR SOCIAL MEDIA*</h1>
          <div className='w-full bg-white h-[0.1rem]'></div>
        </div>
      ...
      <div className='flex items-start justify-start flex-col p-[8em] pb-0 socialMedia'>
        <div className="heading mb-[12em] w-full">
          <h1 className='flex flex-col font-[Poppins] text-[8em] font-medium leading-[1em]'>CONTACT US*</h1>
          <div className='w-full bg-white h-[0.1rem]'></div>
        </div>
        <div className='links gap-[20em] flex w-full'>
          <div className='left'>
            <div className='borderDiv w-fit mb-[6em] text-start items-start justify-start flex flex-col'>
              <a href="#" target="_blank" className='text-white capitalize text-[2em] pr-[3em] pb-[0.5rem]'>PHONE</a>
              <div className='w-full bg-white h-[0.1rem]'></div>
            </div>
            <div className='borderDiv w-fit mb-[6em] text-start items-start justify-start flex flex-col'>
              <a href="#" target="_blank" className='text-white capitalize text-[2em] pr-[3em] pb-[0.5rem]'>EMAIL</a>
              <div className='w-full bg-white h-[0.1rem]'></div>
            </div>
            {/* <div className='borderDiv w-fit mb-[6em] text-start items-start justify-start flex flex-col'>
              <a href="#" target="_blank" className='text-white capitalize text-[2em] pr-[3em] pb-[0.5rem]'>ADDRESS</a>
              <div className='w-full bg-white h-[0.1rem]'></div>
            </div> */}
          </div>
          <div className='right'>
            ...
            <div className='borderDiv w-fit mb-[6em] text-start items-start justify-start flex flex-col'>
              {/* <a href="#" target="_blank" className='text-white capitalize text-[2em] pr-[3em] pb-[0.5rem]'>23-B SECTOR C INDRAPURI GUNA 473001</a> */}
              <div className='w-full bg-white h-[0.1rem]'></div>
            </div>
          </div>
        </div>
